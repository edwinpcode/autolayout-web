...
(function ($, window) {
  ...
  var tabElements = (function () {
    return {
      ...
      getNewElScrollerElementWrappingNavTabsInstance:
        getNewElScrollerElementWrappingNavTabsInstance,
    ...
    function getNewElScrollerElementWrappingNavTabsInstance(
      ...
      var leftArrowContent =
        settings.leftArrowContent || getDefaultLeftArrow(settings);
      var $leftArrow = $(leftArrowContent);
      var rightArrowContent =
        settings.rightArrowContent || getDefaultRightArrow(settings);
  ...
  function buildNavTabsAndTabContentForTargetElementInstance(
    ...
    var $scroller;
    var attachTabContentToDomCallback = ignoreTabPanes
      ? null
      : function () {
  ...
  function checkForTabPropertiesUpdated(refreshData) {
    ...
    if (origTabData[propNames.title] !== newTabData[propNames.title]) {
      getTabAnchor($li).html(
        (origTabData[propNames.title] = newTabData[propNames.title])
      );
      isInitTabsRequired = true;
    }
    ...
    if (refreshData.options.forceActiveTab) {
      ...
      getTabAnchor($li)[
        newTabData[propNames.active] ? "addClass" : "removeClass"
      ]("active");
    ...
    function handleDropdownShow(e) {
      ...
      function handleClickOnDropdownMenuItem(e) {
        ...
        var $selectedMenuItemAnc = $(e.target),
          $selectedMenuItemDropdownMenu =
            $selectedMenuItemAnc.parent(".dropdown-menu"),
